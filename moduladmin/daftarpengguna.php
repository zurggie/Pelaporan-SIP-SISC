            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cart-outline fa-fw" data-icon="v"></i> 
                        ...
                        <span class="hide-menu">Daftar<span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="index.php?id=daftar"><i class="fa-fw"></i><span class="hide-menu">Pengguna</span></a> </li>
                    ...
                    <li> <a href="#" class="waves-effect"><i class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">Laporan<span class="fa arrow"></span> <span class="label label-rouded label-info pull-right"> </span> </span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="index.php?id=senarai_pengguna"><i data-icon="&#xe026;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Senarai Pengguna</span></a></li>
...
WHERE users.KODNEGERI=:kodnegeri  ORDER BY users.real_name ASC";
...
$result->execute();
    ?>                          
                            ...
                            <h3 class="box-title m-b-0">SENARAI NAMA PENGGUNA</h3>
