                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cart-outline fa-fw" data-icon="v"></i> 
                        ...
                        <ul class="nav nav-second-level">
                            <li> <a href="daftarpengguna.php"><i class="fa-fw"></i><span class="hide-menu">Pengguna</span></a> </li>
                    ...
                    <li class="devider"></li>
                    <li><a href="../moduldaftaradmin/home.php" class="waves-effect"><i class="fa fa-circle-o text-danger"></i> <span class="hide-menu">Daftar Pengguna</span></a></li>
...
tkppd.NAMAPPD,
tknegeri.NAMANEGERI,
tknegeri_alias1.NAMANEGERI AS NAMANEGERI2
FROM
users
LEFT JOIN tkppd
...
LEFT JOIN tknegeri AS tknegeri_alias1
ON users.kodnegeri = tknegeri_alias1.KODNEGERI
...
$namanegeri2=$row['NAMANEGERI2']; 
    ...
    if($aras=="60"){
     echo "JPN";  
                                             ...
                                             <td><?php  echo "$kodppd $namappd<br>
                                            $namanegeri $namanegeri2 ";?></td>
                                            <td>
                                            
                                            <a href="../moduladmin/padam.php?user_id=<?php echo $row["user_id"]; ?>" class="link"><img name="delete" id="delete" title="Padam" onclick="return confirm('Anda Pasti Hendak Padam Rekod Ini?')" src="../icon/delete.png"/></a>
