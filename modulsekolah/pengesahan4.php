...
$tarikhmula=isset($_POST['TARIKHS4']) ? $_POST['TARIKHS4'] : null; 
$s2=isset($_POST['S4']) ? $_POST['S4'] : null; 
...
$id=isset($_GET['id']) ? $_GET['id'] :null;  
	...
	$pdo_statement=$auth_user->runQuery("update bersara_nama set TARIKHS4=:tarikhmula,S4=:s4,
    CATATAN=:catatan
    ...
    $pdo_statement->bindParam(':s4',$s4); 
    $pdo_statement->bindParam(':catatan',$catatan); 
    
    $pdo_statement->bindParam(':id',$id);
	$result = $pdo_statement->execute();
	if($result) {
 header("Location: ../modulppd/index.php?id=status");
	}
}
...
bersara_nama.GRED,
bersara_nama.TARIKHS4,bersara_nama.CATATAN,bersara_nama.S4
...
<table border="0" cellpadding="10" cellspacing="0" width="70%" align="center" class="tbl-qa">  
    ...
    <tr><td colspan="3"><h4>Penghantaran Kew 8 Dan Borang SG 20 Ke AG  [TINDAKAN KEWANGAN PPD]</h4></td></tr>
<tr >
    <td>
...
echo " <tr><td>Tarikh </td><td>:</td><td>";
       ...
       <tr>
    <td>
        Catatan PPD</td><td>: </td><td> <input type="text" size="70" name="CATATAN" class="demo-form-field" value="<?php echo $result[0]['CATATAN']; ?>" required  />
    </td>
</tr>             
