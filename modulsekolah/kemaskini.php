...
$nokp=isset($_POST['NOKP']) ? $_POST['NOKP'] : null; 
$namaguru=isset($_POST['NAMAGURU']) ? $_POST['NAMAGURU'] : null; 
$jenissara=isset($_POST['JENISBESARA']) ? $_POST['JENISBESARA'] : null;
$gred=isset($_POST['GRED']) ? $_POST['GRED'] : null;
    
$id=isset($_GET['id']) ? $_GET['id'] :null;  
    
    $namaguru = strtoupper($namaguru); 
	...
	$pdo_statement=$auth_user->runQuery("update bersara_nama set NOKP=:nokp,NAMAGURU=:namaguru,JENISBESARA=:jenissara,
    GRED=:gred,TARIKHBESARA=:tarikhmula
    
    where ID=:id");
  
    $pdo_statement->bindParam(':nokp',$nokp);
    $pdo_statement->bindParam(':namaguru',$namaguru);    
    $pdo_statement->bindParam(':jenissara',$jenissara);  
    $pdo_statement->bindParam(':gred',$gred); 
...
SELECT
bersara_nama.NOKP,bersara_nama.NAMAGURU,bersara_nama.ID,bersara_nama.JENISBESARA,bersara_nama.GRED,
...
<table border="0" cellpadding="10" cellspacing="0" width="80%" align="center" class="tbl-qa">  
    ...
    <tr><td><h4>KEMASKINI REKOD STAF</h4></td></tr>
<tr >
    <td>
        No Kad Pengenalan:</td><td> <input type="text" maxlength="12" size="20" name="NOKP" class="demo-form-field" value="<?php echo $result[0]['NOKP']; ?>" required  />
    </td>
</tr>
                    
<tr  >
    <td>
     Nama Staf: </td><td> <input type="text" size="70" name="NAMAGURU" class="demo-form-field" value="<?php echo $result[0]['NAMAGURU']; ?>" required  />
    </td>
</tr>                    
<tr class="table-row" >
       <td>Jenis Bersara</td><td>
...
<?php print "<option value='";?><?php echo $row['SKALA']; ?>'<?php if ($row['SKALA']==$result[0]['JENISBESARA']) { ?>selected<?php } ?>><?php
...
<?php print "<option value='";?><?php echo $row['kod']; ?>'<?php if ($row['kod']==$result[0]['GRED']) { ?>selected<?php } ?>><?php
...
<?php                    
echo " <tr><td>Tarikh Bersara</td><td>";
 ...
 <tr class="table-row" ><td>
    ...
    <?php echo "<input type=\"hidden\" name=\"ID\" value=\"$id\" />";?>
     ...
     </td><td>    <input name="save_record" type="submit" value="Simpan" class="demo-form-submit">
          
          <a href="index.php?id=pencen" class="demo-form-submit"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Batal</a>
          </td>
                </tr>
