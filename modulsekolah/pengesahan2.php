...
$tarikhmula=isset($_POST['TARIKHS2']) ? $_POST['TARIKHS2'] : null; 
...
$id=isset($_GET['id']) ? $_GET['id'] :null;  
	...
	$pdo_statement=$auth_user->runQuery("update bersara_nama set TARIKHS2=:tarikhmula,S2=:s2,
    CATATAN=:catatan
...
bersara_nama.GRED,
bersara_nama.TARIKHS2,bersara_nama.CATATAN,bersara_nama.S2
...
<table border="0" cellpadding="10" cellspacing="0" width="70%" align="center" class="tbl-qa">  
    ...
    <tr><td colspan="3"><h4>Pengesahan Tarikh Kelulusan Kew 8 persaraan  [TINDAKAN PPD]</h4></td></tr>
<tr >
    <td>
