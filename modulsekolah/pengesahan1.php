...
$tarikhmula=isset($_POST['TARIKHS1']) ? $_POST['TARIKHS1'] : null; 
...
$id=isset($_GET['id']) ? $_GET['id'] :null;  
	...
	$pdo_statement=$auth_user->runQuery("update bersara_nama set TARIKHS1=:tarikhmula,S1=:s1,
...
bersara_nama.GRED,
bersara_nama.TARIKHS1,bersara_nama.CATATANSEKOLAH
...
<table border="0" cellpadding="10" cellspacing="0" width="70%" align="center" class="tbl-qa">  
    ...
    <tr><td colspan="3"><h4>Pengesahan Tarikh Penyediaan Kew 8 Persaraan [TINDAKAN SEKOLAH]</h4></td></tr>
<tr >
    <td>
