...
<head>
    ...
    <title>Dashboard Pelaporan SIP+ Dan Sisc+ KPM</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <!-- .Megamenu -->
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><span class="hidden-xs">Dashboarad KPM</span> <i class="icon-options-vertical"></i></a>
                        <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
                            <li class="col-sm-3">
                                <ul>
                                    <li class="dropdown-header">Bantuan</li>
                                    <li><a href="form-basic.html">email@kpm.edu.my</a></li>
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cart-outline fa-fw" data-icon="v"></i> 
                        ...
                        <span class="hide-menu">SIP+<span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="index.php?id=dg"><i class="fa-fw"></i><span class="hide-menu">Bimbingan SIP</span></a> </li>
                            
                             <li> <a href="index.php?id=dg"><i class="fa-fw"></i><span class="hide-menu">Bimbingan SISC+</span></a> </li>
                    ...
                    <li> <a href="#" class="waves-effect"><i class="mdi mdi-format-color-fill fa-fw"></i> <span class="hide-menu">SISC+<span class="fa arrow"></span> <span class="label label-rouded label-info pull-right"> </span> </span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="#"><i data-icon="&#xe026;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Status</span></a></li>
    ...
    if($id==""){
     ...
     header("Location: ../modulppd/logout.php?logout=true");     
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2018 &copy; Dashboard KPM</footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
