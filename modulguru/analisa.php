...
$stmt = $auth_user->runQuery("SELECT count(*) FROM sisc_guru WHERE JENISBIMBINGAN = 'DTP' AND NOKP='$nokp' ");
$stmt->execute([':nokp','$nokp']);
$kiradtp = $stmt->fetchColumn();
    
$stmt = $auth_user->runQuery("SELECT count(*) FROM sisc_guru WHERE JENISBIMBINGAN = 'PRIME' AND NOKP='$nokp' ");
$stmt->execute([':nokp','$nokp']);
$kiraprime = $stmt->fetchColumn();     

$stmt = $auth_user->runQuery("SELECT count(*) FROM sisc_guru WHERE JENISBIMBINGAN = 'TS25' AND NOKP='$nokp' ");
$stmt->execute([':nokp','$nokp']);
$kirats25 = $stmt->fetchColumn(); 

$stmt = $auth_user->runQuery("SELECT count(*) FROM sisc_guru WHERE JENISBIMBINGAN = 'KELOMPOK' AND NOKP='$nokp' ");
$stmt->execute([':nokp','$nokp']);
