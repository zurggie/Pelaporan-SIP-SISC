...
$id=isset($_GET['id']) ? $_GET['id'] :null;  
	...
	$pdo_statement=$auth_user->runQuery("update sisc_guru set PP1=:tarikhmula,
...
<a href="../modulsisc/index.php?id=kedatangan" class="demo-form-submit"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Batal</a> |
