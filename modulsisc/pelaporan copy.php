...
$tarikhx=date('d M Y',strtotime($tarikhy));
     ...
     echo "<script>alert('Laporan Ke $bilke telah dihantar, sila buat semakan.');</script>";
       ...
       // $kelas = strtoupper($kelas);
        ...
        S411,S421,S422,S431,S441,S442,S451,S461) 
...
<tr class="table-row" >
    ...
    <select name="BILKE" id="BILKE">
 <?php
 	$stmt = $auth_user->runQuery("SELECT KOD,PERKARA FROM kodbilangan");
	$stmt->execute();
	foreach ($stmt as $row) 
 {
 ?>
 
<?php print "<option value='";?><?php echo $row['KOD']; ?>'<?php if ($row['KOD']==$bilke) { ?>selected<?php } ?>><?php
...
<td><center><input type="text" maxlength="5"  size="5" name="S411" required ></center> </td>
                
<td><center><input type="text" maxlength="5"  size="5" name="S421" required ></center>                  
</td><td><center><input type="text" maxlength="5"  size="5" name="S422" required ></center>
</td><td><center><input type="text" maxlength="5"  size="5" name="S431" required ></center>
</td><td><center><input type="text" maxlength="5"  size="5" name="S441" required ></center>
</td><td><center><input type="text" maxlength="5"  size="5" name="S442" required ></center></td><td><center><input type="text" maxlength="5"  size="5" name="S451" required ></center>
</td><td><center><input type="text" maxlength="5"  size="5" name="S461" required ></center>
</td>
<td>
