        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-left">
                    ...
                    <!-- .Megamenu -->
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><span class="hidden-xs">Dashboard JPN</span> <i class="icon-options-vertical"></i></a>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-cart-outline fa-fw" data-icon="v"></i> 
                        ...
                        <ul class="nav nav-second-level">
                            <li> <a href="analisanegeri.php?id=negerippd"><i class="fa-fw"></i><span class="hide-menu">PPD</span></a> </li>
                           
                            <li> <a href="analisanegeri.php?id=negerisisc"><i class="fa-fw"></i><span class="hide-menu">SISC+</span></a> </li>
                        </ul>
                    </li>
...
sip.JAWATAN,
sip.AKADEMIK,
sip.41_Pembentangan,sip.42a_KepimpinanPGB,
sip.PBPPP
FROM
sip

WHERE sip.KODNEGERI=:kodnegeri  ORDER BY sip.NAMA ASC";
...
foreach ($result as $row) {
                        ...
                        $nama=$row['NAMA'];
                        $nokp=$row['NOKP'];
                        $s41=$row['41_Pembentangan'];
                      //  $42a=$row['42a_KepimpinanPGB'];
