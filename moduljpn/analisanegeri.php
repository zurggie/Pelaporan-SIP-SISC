...
$sql = "Select users.kodnegeri,tkppd.NAMAPPD,
...
INNER JOIN tkppd ON sisc_guru_data.KODPPD = tkppd.KODPPD
where users.kodnegeri=:kodnegeri
GROUP BY
tkppd.NAMAPPD
ORDER BY
tkppd.NAMAPPD ASC";
...
$result->execute();
    ...
    ?>
                            ...
                            <h3 class="box-title m-b-0">Analisa Bimbingan Guru Dibimbing Ikut PPD</h3>
...
$sql = "Select users.kodnegeri,tkppd.NAMAPPD,users.real_name,
SUM(case when S411<>0  then 1 else 0 end) as 'S411',
SUM(case when S421<>0  then 1 else 0 end) as 'S421',
SUM(case when S422<>0  then 1 else 0 end) as 'S422',
SUM(case when S431<>0  then 1 else 0 end) as 'S431',
...
where users.kodnegeri=:kodnegeri
GROUP BY
tkppd.NAMAPPD,users.real_name
ORDER BY
tkppd.NAMAPPD ASC,users.real_name ASC";
...
$result->execute();
    ...
    ?>
                            ...
                            <h3 class="box-title m-b-0">Analisa Bimbingan Guru Dibimbing Ikut PPD & SISC+</h3>
                            <p class="text-muted m-b-30">Eksport data Ke Salin, CSV, Excel, PDF & Print</p>
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
